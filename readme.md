...
Copy `rose-pine{-moon,-dawn}.conf` to your colorschemes directory:
...
Open [Geany](https://www.geany.org) and apply by selecting your desired variant from "view" &rarr; "Change color scheme".
...
```sh
npx @rose-pine/build@0.8.0 -t template.conf
```
